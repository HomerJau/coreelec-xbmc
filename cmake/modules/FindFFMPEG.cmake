...
if(WITH_FFMPEG)
  ...
  if(KODI_DEPENDSBUILD OR (WIN32 OR WINDOWS_STORE))
    ...
    # libpostproc is NOT in the upstream ffmpeg tarball — it is added by
    # tools/depends/target/ffmpeg/001-ffmpeg-all-libpostproc-plugin.patch, so its version is
    # governed by that patch and does NOT move with the ffmpeg point release. Left unchanged.
